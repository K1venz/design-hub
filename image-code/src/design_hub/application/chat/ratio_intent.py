...
from design_hub.domain.image_capabilities import supported_image_ratios

SUPPORTED_CHAT_RATIOS = supported_image_ratios()
...
class ChatRatioDecision:
    ...
    def require_supported(self) -> str:
        ...
        raise UnsupportedChatRatio(
            f"当前支持的图片比例是 {options}，你填写的 "
            f"{self.requested} 暂不支持。"
        )

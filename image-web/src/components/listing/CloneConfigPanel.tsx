  ...
  return (
    <div className="flex w-[392px] shrink-0 flex-col border-r border-[#ece8e2] bg-white">
      <div className="flex-1 overflow-auto p-5">
        ...
        <p className="mb-2 text-[11.5px] text-[#9b958c]">将原样保真出现在成品里</p>
        ...
        <p className="mb-2 text-[11.5px] text-[#9b958c]">只借它的结构与风格，模板上的产品与文案不会出现在成品</p>
        ...
        <h4 className="mb-2.5 mt-5 text-[13px] font-bold">
          统一复刻要求 <span className="font-normal text-[#9b958c]">（选填）</span>
        </h4>
        <textarea
          value={config.prompt}

...
2. Send a branded infrastructure test to `privacy-redacted@users.noreply.github.com` and confirm Gmail
   accepts it.
3. Confirm that `privacy-redacted@users.noreply.github.com` already belongs to an application account.
